...
const routes = [
    {
        path: '',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_shared_action-button_action-button_module_ts-src_assets_i18n_de_json-src_asse-a955c8"), __webpack_require__.e("default-src_app_tab-projects_tab-projects_module_ts"), __webpack_require__.e("src_app_tabs_tabs_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./tabs/tabs.module */ 5564)).then(m => m.TabsPageModule)
    },
    {
        path: 'team',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_shared_action-button_action-button_module_ts-src_assets_i18n_de_json-src_asse-a955c8"), __webpack_require__.e("default-src_app_tab-projects_tab-projects_module_ts"), __webpack_require__.e("default-src_app_tab-team_tab-team_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./tab-team/tab-team.module */ 2319)).then(m => m.TabTeamPageModule)
    },
    {
        path: 'slider',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-src_app_shared_action-button_action-button_module_ts-src_assets_i18n_de_json-src_asse-a955c8"), __webpack_require__.e("common"), __webpack_require__.e("src_app_shared_slider_slider_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./shared/slider/slider.module */ 8888)).then(m => m.SliderPageModule)
    },
];
...
/* harmony import */ var _shared_partner_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./shared/partner.service */ 1507);
...
let AppComponent = class AppComponent {
    ...
    //#endregion
    //#region [ CONSTRUCTORS ] //////////////////////////////////////////////////////////////////////
    constructor(authService, translate, partnerService) {
...
AppComponent.ctorParameters = () => [
    ...
    { type: _shared_partner_service__WEBPACK_IMPORTED_MODULE_3__.PartnerService }
];
...
/* harmony import */ var firebase_compat_app__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! firebase/compat/app */ 8427);
/* harmony import */ var firebase_compat_firestore__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! firebase/compat/firestore */ 7624);
/* harmony import */ var firebase_compat_auth__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! firebase/compat/auth */ 7210);
...
const firestore = firebase_compat_app__WEBPACK_IMPORTED_MODULE_3__["default"].firestore();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (firebase_compat_app__WEBPACK_IMPORTED_MODULE_3__["default"]);
const createTranslateLoader = (http) => new _ngx_translate_http_loader__WEBPACK_IMPORTED_MODULE_6__.TranslateHttpLoader(http, './assets/i18n/', '.json');
let AppModule = class AppModule {
};
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_8__.NgModule)({
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_1__.AppComponent,],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_9__.BrowserModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_10__.IonicModule.forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_0__.AppRoutingModule, _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_11__.BrowserAnimationsModule,
            _angular_fire_compat__WEBPACK_IMPORTED_MODULE_12__.AngularFireModule.initializeApp(_environments_environment__WEBPACK_IMPORTED_MODULE_2__.environment.firebase, 'angularfs'),
        ...
        providers: [{ provide: _angular_router__WEBPACK_IMPORTED_MODULE_17__.RouteReuseStrategy, useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_10__.IonicRouteStrategy }],
...
let AuthenticationService = class AuthenticationService {
    ...
    autoAuthentication() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            yield _capacitor_preferences__WEBPACK_IMPORTED_MODULE_0__.Preferences.get({ key: 'user-id' }).then((user) => {
                if (user.value) {
                    return;
                }
    ...
    signInAnonymously() {
        return new Promise((resolve, reject) => {
            this.fireAuth.signInAnonymously().then((data) => (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
                resolve(data);
...
/***/ 1507:
/*!*******************************************!*\
  !*** ./src/app/shared/partner.service.ts ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let PartnerService = class PartnerService {
    ...
    loadPartner() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            yield _capacitor_preferences__WEBPACK_IMPORTED_MODULE_0__.Preferences.get({ key: 'latest-partner' }).then((partner) => {
                if (partner.value) {
...
PartnerService = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
